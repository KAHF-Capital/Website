...
export const siteConfig = {
  brand: 'KAHF Capital',
  product: 'KAHF AI',
  tagline: 'Your personal volatility analyst.',
  subTagline: 'Trained on a decade of institutional flow, dark pool prints, and earnings straddles. Ask anything in plain English — get a tradeable read in seconds.',
