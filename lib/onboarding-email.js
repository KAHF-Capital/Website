...
const STEPS = {
  welcome: {
    ...
    body: ({ email }) => `
      ...
      <p style="color:#333;line-height:1.6">You just unlocked the same dark pool + earnings straddle data the desks use, plus an AI analyst that does the math for you in plain English.</p>
      <p style="color:#333;line-height:1.6"><strong>Try it now:</strong></p>
      <ul style="color:#333;line-height:1.7">
        <li>Ask <em>"Find me a high-conviction trade right now"</em> on <a href="${SITE_URL}/sonnet" style="color:#059669">KAHF AI</a>.</li>
        <li>Browse today's institutional prints on the <a href="${SITE_URL}/scanner" style="color:#059669">free scanner</a>.</li>
        <li>Pull historical earnings straddle stats on the <a href="${SITE_URL}/straddle-calculator" style="color:#059669">straddle calculator</a>.</li>
      </ul>
  ...
  day1: {
    ...
    body: () => `
      ...
      <p style="color:#333;line-height:1.6"><strong>Straddle success rate.</strong> Historical hit rate of an ATM straddle on this ticker. 55%+ means the move is large enough to pay for itself.</p>
      <p style="color:#333;line-height:1.6"><strong>Catalyst.</strong> Earnings, FDA, M&amp;A, analyst action. No catalyst = no edge.</p>
      <p style="color:#333;line-height:1.6">Want all four checks scored automatically? <a href="${SITE_URL}/sonnet" style="color:#059669">Ask KAHF AI to grade today's setups.</a></p>
    `
  },
  day3: {
    ...
    body: () => `
      ...
      <p style="color:#333;line-height:1.6"><a href="${SITE_URL}/sonnet" style="color:#059669"><strong>Try it free →</strong></a></p>
    `
  },
  day7: {
