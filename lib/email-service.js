  ...
  try {
    ...
    <div style="background:#0a0a14;padding:32px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
      <div style="max-width:${hasStraddle ? '600' : '520'}px;margin:0 auto">
        ...
        <hr style="border:none;border-top:1px solid #1a1a2e;margin:28px 0 20px" />
        <p style="color:#35354a;font-size:10px;line-height:1.5;margin:0">KAHF Capital LLC is not a registered investment adviser, broker-dealer, or financial planner. The dark pool volume alerts and associated options straddle performance data provided by this service are for informational and educational purposes only and do not constitute investment advice, a recommendation, or a solicitation to buy, sell, or hold any security, option, or financial instrument.</p>
        <p style="color:#35354a;font-size:10px;line-height:1.5;margin:10px 0 0">Alerts identifying elevated relative volume dark pool activity and historical success rates of options straddles are derived from publicly reported data and third-party sources believed to be reliable but not guaranteed for accuracy or completeness. Past performance is not indicative of future results. Backtested performance has inherent limitations, including hindsight bias, and does not account for slippage, commissions, liquidity constraints, or real-world execution conditions. Any forward-looking projections or probability estimates are hypothetical and may not reflect actual future outcomes.</p>
        <p style="color:#35354a;font-size:10px;line-height:1.5;margin:10px 0 0">Trading securities and options involves substantial risk of loss, including loss of your entire investment. Options carry additional risks including leverage, time decay, and illiquidity. Nothing in this communication creates a fiduciary relationship or obligation between KAHF Capital and the recipient. You should consult a qualified financial professional before making any investment decisions.</p>
        <p style="color:#35354a;font-size:10px;line-height:1.5;margin:10px 0 0">KAHF Capital and its affiliates may hold positions in securities referenced herein and have no obligation to disclose such holdings. Use of this service is at your own risk.</p>
      </div>
    </div>`;
