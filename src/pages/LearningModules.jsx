  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case "when-to-use":
        return (
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">When to Use This Strategy</h3>
      ...
      case "risk-profile":
        return (
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Risk Profile</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center p-3 sm:p-4 border border-gray-200 rounded-lg bg-white">
                <div className="w-8 sm:w-10 h-8 sm:h-10 bg-green-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <TrendingUp className="h-4 sm:h-5 w-4 sm:w-5 text-green-600" />
                </div>
                <h4 className="text-gray-900 font-medium mb-1 text-sm sm:text-base">Max Profit</h4>
                <p className="text-green-600 text-xs sm:text-sm font-medium">{currentStrategy.riskProfile.maxProfit}</p>
              </div>
              <div className="text-center p-3 sm:p-4 border border-gray-200 rounded-lg bg-white">
                <div className="w-8 sm:w-10 h-8 sm:h-10 bg-red-100 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <Shield className="h-4 sm:h-5 w-4 sm:w-5 text-red-600" />
                </div>
                <h4 className="text-gray-900 font-medium mb-1 text-sm sm:text-base">Max Loss</h4>
                <p className="text-red-600 text-xs sm:text-sm font-medium">{currentStrategy.riskProfile.maxLoss}</p>
              </div>
              <div className="text-center p-3 sm:p-4 border border-gray-200 rounded-lg bg-white">
                ...
                <h4 className="text-gray-900 font-medium mb-1 text-sm sm:text-base">Breakeven</h4>
                <p className="text-gray-600 text-xs sm:text-sm font-medium">{currentStrategy.riskProfile.breakeven}</p>
              </div>
            </div>
          </div>
        );
      case "dark-pool":
        return (
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Dark Pool Analytics</h3>
            <div className="space-y-3">
              {currentStrategy.darkPoolInsights.map((insight, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <div className="w-5 sm:w-6 h-5 sm:h-6 bg-gray-600 rounded-full flex items-center justify-center flex-shrink-0">
